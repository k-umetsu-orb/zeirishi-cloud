...
export default function IntroductionQuestionnaireLp01() {
  ...
  async function submit() {
    ...
    try {
      const response = await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          sourcePage: "/introduction-lp01/step",
          clientType,
      ...
      await router.push("/introduction-lp01/thanks");
    } catch {
    ...
    <div className="min-h-screen bg-[#e5f4fd] text-[#153e79]">
      <main className="intro-questionnaire">
        <div className="intro-questionnaire__progress-wrap">
          <Link href="/introduction-lp01" className="intro-questionnaire__brand" aria-label="税理士クラウド紹介サービスへ戻る">
